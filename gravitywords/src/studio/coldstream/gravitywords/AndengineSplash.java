			...
			public void onTimePassed(final TimerHandler pTimerHandler) {
				...
				if(DEBUG_MODE){
					if(AndengineSplash.this.mEngine.getSecondsElapsedTotal() > 4.0f){
						Intent mainIntent = new Intent(AndengineSplash.this, MainActivity.class);
						AndengineSplash.this.startActivity(mainIntent);
						AndengineSplash.this.finish();
					}
				}
				else{
					if(AndengineSplash.this.mEngine.getSecondsElapsedTotal() > 10.5f){
						Intent mainIntent = new Intent(AndengineSplash.this, MainActivity.class);
						AndengineSplash.this.startActivity(mainIntent);
						AndengineSplash.this.finish();
					}
